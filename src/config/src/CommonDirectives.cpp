...
/*   Updated: 2024/02/15 13:15:36 by kchaouki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	check_unexpected(const string& to_check, const string& direc)
{
...
void	CommonDirectives::setAlias(const string& _alias)
{
	if (check[1])
